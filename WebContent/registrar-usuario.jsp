...
<body>
	...
	<div class="contenedorPrincipal">
		...
		<main>
			...
			<h2 class="subTituloCuerpo">Registro de Usuario</h2>
			...
			<div style="margin-left: 20%; margin-right: 20%;">
				...
				<form action="us" method="post" id="frmBase">
					...
					<div class="form-group">
						<label>Tipo:</label> <br> <select name="cboTipo"
							class="form-control">
							<tools:cboTipoUsuario/>
						</select>
					</div>
				...
				<br>
				<p>
					Si ya tiene cuenta ingrese <a href="login.jsp" style="color:blue;">aquí</a>
				</p>
				<p>
		...
		<footer>
			<div id="imgredes">
				<a target="_blank" href="https://www.facebook.com/"><img
					class="redes" src="img/facebook.png" alt=""></a> <a
					target="_blank" href="https://www.instagram.com/"><img
					class="redes" src="img/instagram.png" alt=""></a> <a
					target="_blank" href="https://twitter.com"><img class="redes"
					src="img/twiterr.png" alt=""></a>
